...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Universitas Kristen Duta Wacana</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="/home">
              <span data-feather="home" class="align-text-bottom"></span><i class="bi bi-house-fill"></i>
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="/user">
              <span data-feather="file" class="align-text-bottom"></span><i class="bi bi-person-fill"></i>
              User
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="/mhs">
              <span data-feather="file" class="align-text-bottom"></span><i class="bi bi-people-fill"></i>
              Mahasiswa
            </a>
          </li>
        </ul>
        ...
        <ul class="nav flex-column mb-2">
          <li class="nav-item">
            <a class="nav-link" href="https://calendar.google.com/calendar/u/0/r?pli=1">
              <span data-feather="file-text" class="align-text-bottom"></span><i class="bi bi-calendar2-date-fill"></i>
              Kalender
            </a>
        </ul>
      </div>
